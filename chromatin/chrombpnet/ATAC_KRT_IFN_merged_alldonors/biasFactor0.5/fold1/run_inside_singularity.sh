#!/bin/bash
base_dir=/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_KRT_IFN_merged_alldonors/biasFactor0.5
data_dir=/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_KRT_IFN_merged_alldonors/biasFactor0.5/data
fold_dir=/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_KRT_IFN_merged_alldonors/biasFactor0.5/fold1
prefix=ATAC_KRT_IFN_merged_alldonors
BIAS_FACTOR=0.5
FOLD=1

# fold 0 bias model path — reused for folds 1-4
bias_model_fold0=/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_KRT_IFN_merged_alldonors_biasFactor0.5/bias_model/models/ATAC_KRT_IFN_merged_alldonors_fold0_bias.h5
