#!/bin/bash
#BSUB -J chrombpnet-b0.6
#BSUB -n 10
#BSUB -R "span[hosts=1]"
#BSUB -R "rusage[mem=10240]"
#BSUB -q gpu
#BSUB -W 720:00
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_F111_KRT_PBS_S1_b0.6/log_pipeline.%J.err"
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_F111_KRT_PBS_S1_b0.6/log_pipeline.%J.out"

# preprocess ChromBPNet tutorial data
dir="/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_F111_KRT_PBS_S1_b0.6"
cd ${dir}
mkdir -p ${dir}/data
