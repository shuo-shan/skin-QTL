...
#BSUB -q gpu
#BSUB -W 720:00
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_F111_KRT_PBS_S1_b0.7/log_pipeline.%J.err"
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_F111_KRT_PBS_S1_b0.7/log_pipeline.%J.out"

# preprocess ChromBPNet tutorial data
dir="/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/chrombpnet/ATAC_F111_KRT_PBS_S1_b0.7"
cd ${dir}
mkdir -p ${dir}/data
