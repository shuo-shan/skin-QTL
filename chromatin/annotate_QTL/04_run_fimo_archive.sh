...
### optionally remove fimo folders
rm SNP.bed snp_position_in_seq.txt SNP_slop100.fa SNP_slop100_REF.fa SNP_slop100_ALT.fa
rm fimo_all_REF.tsv fimo_all_ALT.tsv
rm -r ${workingdir}/results_REF
rm -r ${workingdir}/results_ALT
