...
def main(ratio_file, pcs=50):
    ...
    #file = ratio_file
    sys.stderr.write("file is: "+ratio_file+"\n")
    for i in range(1,23):
        fout[i] = open(ratio_file+".phen_chr%d"%i,'w') # create a file to write in for each of the 22 autosomes
        fout_ave = open(ratio_file+".ave",'w') # create a file to write in for average phenotype
