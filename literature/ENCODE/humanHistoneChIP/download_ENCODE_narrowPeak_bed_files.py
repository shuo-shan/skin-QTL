...
url="https://www.encodeproject.org/search/?type=Experiment&control_type%21=%2A&status=released&perturbed=false&replicates.library.biosample.donor.organism.scientific_name=Homo+sapiens&biosample_ontology.cell_slims=epithelial+cell&biosample_ontology.cell_slims=fibroblast&biosample_ontology.cell_slims=connective+tissue+cell&biosample_ontology.cell_slims=keratinocyte&assay_title=Histone+ChIP-seq"
