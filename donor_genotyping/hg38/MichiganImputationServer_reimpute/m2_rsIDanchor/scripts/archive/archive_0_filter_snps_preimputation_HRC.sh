...
SNPS_TO_REMOVE="${dir}/pre_imputation_vcf_HRC/statistics/HRC_snps-excluded.txt"
MHC_SNPS_TO_SET_REF="${dir}/pre_imputation_vcf_HRC/MHC_set_ref_snps.txt"
...
for chr in {1..23}; do
  ...
  plink2 \
    ...
    --recode vcf \
    --out "${dir}/pre_imputation_vcf_HRC/chr${chr}_all_samples_ibd_hwe_0.001"
...
#    --out "${dir}/pre_imputation_vcf_HRC/chr${chr}_all_samples_ibd_hwe_0.001"
  ...
  VCF_FILE="${dir}/pre_imputation_vcf_HRC/chr${chr}_all_samples_ibd_hwe_0.001.vcf"
...
plink2 \
  ...
  --remove <(awk '$2=="skineQTL-F086" || $2=="skineQTL-F104"{print $1, $2}' "${STARTING_BFILE}.fam") \
  --recode vcf \
  --out "${dir}/pre_imputation_vcf_HRC/chr6_MHC_all_samples_ibd_hwe_0.001"
...
MHC_VCF="${dir}/pre_imputation_vcf_HRC/chr6_MHC_all_samples_ibd_hwe_0.001.vcf"
...
# Clean up logs
mkdir -p ${dir}/pre_imputation_vcf_HRC/logs
mv ${dir}/pre_imputation_vcf_HRC/*.log ${dir}/pre_imputation_vcf_HRC/logs 2>/dev/null
rm -f ${dir}/pre_imputation_vcf_HRC/*.hh
rm -f ${dir}/pre_imputation_vcf_HRC/*.nosex
