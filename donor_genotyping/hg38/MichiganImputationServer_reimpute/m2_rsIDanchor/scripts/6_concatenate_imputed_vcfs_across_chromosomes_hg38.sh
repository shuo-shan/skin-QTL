...
#BSUB -o step6_concat_all_chr_hg38.out
#BSUB -e step6_concat_all_chr_hg38.err
#BSUB -n 8
#BSUB -q short
#BSUB -W 02:00
...
HG38_PREFIX="chr{CHR}_imputed_combined_hg38_rsID.vcf.gz"

# Output file bases
HG38_OUT_BASE=skineQTL_imputed_hg38
