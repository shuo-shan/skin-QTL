...
#bcftools view --include ID==@skin_disease_GWAS_SNPs_MAFlessthan0.01.txt ${f} -Oz -o ${dir}/analysis/${donor}.snp.vcf.gz
#bcftools view --include ID==@skin_disease_GWAS_SNPs_MAFgreaterthan0.2.txt ${f} -Oz -o ${dir}/analysis/${donor}.snp.vcf.gz
#bcftools view --include ID==@skin_disease_GWAS_SNPs_MAF0.01-0.1.txt ${f} -Oz -o ${dir}/analysis/${donor}.snp.vcf.gz
bcftools view --include ID==@skin_disease_GWAS_SNPs_MAFgreaterthan0.4.txt ${f} -Oz -o ${dir}/analysis/${donor}.snp.vcf.gz
