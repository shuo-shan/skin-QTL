...
expressedGenes=${geneExprs_mel}
promoters=${promoters_mel} # promoter name is column#4
enhancers=${enhancers_mel} # enhancer name is column#21
celltype=MEL # KRT, FRB, MEL
