...
for s in CSL_RNA_1_S9  CSL_RNA_2_S10  CSL_RNA_3_S11  CSL_RNA_4_S12;do
  echo "working on" ${s}; date
  cd /nl/umw_manuel_garber/human/skin/eQTLs/Nextseq2000/20220812_Celseq2/fastq_RNAseq/2022_08_09_DC_IFNg_RNA
  ...
  cd $Dir/fastq_RNAseq/2022_08_09_DC_IFNg_RNA/${s}
  for i in $(ls *fq);do
