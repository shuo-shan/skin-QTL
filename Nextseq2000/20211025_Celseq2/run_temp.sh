...
#BSUB -q long
#BSUB -W 21:00
#BSUB -o "/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq2000/20211025_Celseq2/%J%I.demultiplex.out"
#BSUB -e "/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq2000/20211025_Celseq2/%J%I.demultiplex.err"
#########################################
...
for s in F36F_F37F_F38F_F39F_S8 F40F_F41F_F42F_F44F_S9 F45F_F46F_F47F_F48F_S10 F46K_F47K_S2 F48K_F49K_F23F_F24F_S3 F49F_F50F_F51F_F52F_S11 F50K_F51K_F27F_F28F_S4 F52K_F53K_F30F_F31F_S5 F55K_F56K_F32F_F33F_S6 F57K_F58K_F34F_F35F_S7 F59K_F60K_S1;do
  ...
  for i in $(ls *fq);do
    ...
    cat ${i} | awk '{if (NR%4==1) gsub("_",":",$1); print}' | gzip > $Dir/fastq/${fname}.fq.gz
    rm ${i}
    echo ${i}
    date
  done
