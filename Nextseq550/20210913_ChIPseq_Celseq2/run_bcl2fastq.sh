...
#BSUB -q long
#BSUB -W 21:00
#BSUB -o "/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210913_ChIPseq_Celseq2/%J%I.splitfq_by_cs2.out"
#BSUB -e "/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210913_ChIPseq_Celseq2/%J%I.splitfq_by_cs2.err"
module load bcl2fastq/2.17.1.14
# 09_13_21 sequencing data with Ken
# Illumina NextSeq550, pair-end, single-index 8bp for ChIPseq and 6bp for Celseq2 RPI barcode
indir=/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210913_ChIPseq_Celseq2/basespace
...
#     Step 3: rsync -av *.xml *.txt *.csv to_path_in_cluster/
...
##########################################
## merge
#dir=/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210913_ChIPseq_Celseq2/basespace/fastqs/chip_rnaseq_09-13-21
#cd $dir
##ls | cut -d"_" -f1-3 | sort | uniq | tr '\n' ' '
#for x in Celseq2_1_S1 Celseq2_2_S2 Celseq2_3_S3 Celseq2_4_S4 Celseq2_5_S5 Celseq2_6_S6 Celseq2_7_S7 ChIP_1_S1 ChIP_2_S2 ChIP_3_S3 ChIP_4_S4 ChIP_5_S5 ChIP_6_S6 ChIP_7_S7;do
...
Dir=/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210913_ChIPseq_Celseq2
for s in Celseq2_1_S1 Celseq2_2_S2 Celseq2_3_S3 Celseq2_4_S4 Celseq2_5_S5 Celseq2_6_S6 Celseq2_7_S7;do
  echo "working on" ${s}
  date
