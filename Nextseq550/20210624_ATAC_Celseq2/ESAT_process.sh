...
### working in /nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210624_ATAC_Celseq2/
### set-up
...
#cd ${Dir}/DolphinNext_Celseq2/report4834/star
#for i in *.bam; do
#  f=${Dir}/DolphinNext_Celseq2/report4834/star/${i}
...
#  echo -e "$id"'\t'/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210624_ATAC_Celseq2/bam_bcmodified/"$i" > $Dir/ESAT/input_names/align_$i
#done
## run ESAT
#cd $Dir/bam_bcmodified
