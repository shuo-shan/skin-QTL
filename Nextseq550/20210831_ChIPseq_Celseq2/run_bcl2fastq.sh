...
#BSUB -q long
#BSUB -W 21:00
#BSUB -o "/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210831_ChIPseq_Celseq2/%J%I.laneMerge_cs2Split_Celseq2.out"
#BSUB -e "/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210831_ChIPseq_Celseq2/%J%I.laneMerge_cs2Split_Celseq2.err"
module load bcl2fastq/2.17.1.14
# 08_31_21 sequencing data with Ken, Wei
# Illumina NextSeq550, pair-end, single-index 8bp for ChIPseq and 6bp for Celseq2 RPI barcode
indir=/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210831_ChIPseq_Celseq2/basespace
...
#########################################
## merge
dir=/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210831_ChIPseq_Celseq2/basespace/fastqs/chip_rnaseq_08-31-21
cd $dir
#ls | cut -d"_" -f1-3 | sort | uniq | tr '\n' ' '
#for x in Celseq2_1_S1 Celseq2_2_S2 Celseq2_3_S3 Celseq2_4_S4 Celseq2_5_S5 Celseq2_6_S6 Celseq2_7_S7 Celseq2_8_S8;do
for x in Celseq2_1_S1;do
...
Dir=/nl/umw_manuel_garber/human/skin/eQTLs/Nextseq550/20210831_ChIPseq_Celseq2
#for s in Celseq2_1_S1 Celseq2_2_S2 Celseq2_3_S3 Celseq2_4_S4 Celseq2_5_S5 Celseq2_6_S6 Celseq2_7_S7 Celseq2_8_S8;do
for s in Celseq2_1_S1;do
  echo "working on" ${s}
  date
