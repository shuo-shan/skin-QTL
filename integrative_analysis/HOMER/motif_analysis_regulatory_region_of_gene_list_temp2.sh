...
keyword=melanocyte_induced_genes_enhancer
genes=/pi/manuel.garber-umw/human/skin/eQTLs/RNA-Seq/melanocytes/pipeline_12022022/analysis/upregulated_genes_p0.05_log2FC1.txt
