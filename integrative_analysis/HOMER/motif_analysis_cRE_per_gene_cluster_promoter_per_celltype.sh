...
grep -f ${dir}/temp.genes ${dict_gene_promoter} | cut -f2 > temp.this_gene_cluster_promoter
grep -f temp.this_gene_cluster_promoter ${cRE_bed} | cut -f1-4 > this_gene_cluster_promoter.bed
...
grep -f ${dir}/temp.genes ${dict_gene_pruned_promoter} | cut -f2 > temp.this_gene_cluster_pruned_promoter
grep -f temp.this_gene_cluster_pruned_promoter ${cRE_bed} | cut -f1-4 > this_gene_cluster_pruned_promoter.bed
# clean-up
rm temp*
