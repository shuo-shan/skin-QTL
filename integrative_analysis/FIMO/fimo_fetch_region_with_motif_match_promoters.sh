...
#geneF=${dir}/STAT1_highly_correlated_genes.txt # generated by /pi/manuel.garber-umw/human/skin/eQTLs/integrative_analysis/utility_correlate_two_genes_CPM.R
#regionTag=STAT1HighCorrelationGenesPromoters # syntax: camel
geneF=${dir}/IFNg_induced_genes.txt # generated by /pi/manuel.garber-umw/human/skin/eQTLs/integrative_analysis/utility_correlate_two_genes_CPM.R
regionTag=InducedGenes
...
cd ${dir}
TF=IRF1
#regionF=${dir}/STAT1_STAT1HighCorrelationGenesPromoters/fimo_topRanked_STAT1_motif_center_flanking_1kb.bed
#regionTag=STAT1TopMatchingSTAT1HighCorrelationGenesPromoters
regionF=${dir}/STAT1_InducedGenes/fimo_topRanked_STAT1_motif_center_flanking_1kb.bed
regionTag=STAT1TopMatchingInducedGenesPromoters
...
cd ${dir}
regionF=${dict_gene_promoter}
#geneF=${dir}/STAT1_poorly_correlated_genes.txt # generated by /pi/manuel.garber-umw/human/skin/eQTLs/integrative_analysis/utility_correlate_two_genes_CPM.R
geneF=${dir}/non_IFNg_induced_genes_number_matched.txt # generated by /pi/manuel.garber-umw/human/skin/eQTLs/integrative_analysis/utility_correlate_two_genes_CPM.R
#regionTag=STAT1LowCorrelationGenesPromoters # syntax: camel
regionTag=NonInducedGenes
grep -f ${geneF} ${regionF} | awk '{OFS="\t"}{print $1"_"$2"_"$3}' | sort | uniq | tr '_' '\t' | awk '{OFS="\t"}{print $1,$2,$3,$1"_"$2"_"$3}' > regions.bed
run_FIMO ${dir} ${TF} regions.bed 50
mv ${dir}/${TF} ${dir}/${TF}_${regionTag}
mv ${dir}/regions.bed ${dir}/${TF}_${regionTag}/regions.bed
...
cd ${dir}
TF=IRF1
#regionF=${dir}/STAT1_STAT1LowCorrelationGenesPromoters/fimo_topRanked_STAT1_motif_center_flanking_1kb.bed
regionF=${dir}/STAT1_NonInducedGenes/fimo_topRanked_STAT1_motif_center_flanking_1kb.bed
#regionTag=STAT1TopMatchingSTAT1LowCorrelationGenesPromoters
regionTag=STAT1TopMatchingNonInducedGenesPromoters
cat ${regionF} | awk '{OFS="\t"}{print $1"_"$2"_"$3"_"$6}' | sort | uniq | tr '_' '\t' | awk '{OFS="\t"}{print $1,$2,$3,$1"_"$2"_"$3,$4}' > regions.bed
run_FIMO ${dir} ${TF} regions.bed 50
mv ${dir}/${TF} ${dir}/${TF}_${regionTag}
mv ${dir}/regions.bed ${dir}/${TF}_${regionTag}/regions.bed
