...
##### 1. For TF1, fetch the TF1-containing promoters of TF1- highly-correlated and poorly-correlated genes.
cd /pi/manuel.garber-umw/human/skin/eQTLs/integrative_analysis/FIMO/results/${TF1}
bash ${scriptDir}/fetch_TF1_containing_regions.sh ${TF1}
