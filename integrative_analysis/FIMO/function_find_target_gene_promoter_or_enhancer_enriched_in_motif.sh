...
bedtools intersect -wb -a ${dir}/${TF}/fimo_${TF}.bed -b ${dict_linked_gene_cRE} | awk '{print $15}' | sort | uniq > ${dir}/FIMO_predicted_genes_with_${TF}_in_promoter_or_enhancer.txt
# clean-up
cd ${dir}
rm -r ${dir}/${TF}
