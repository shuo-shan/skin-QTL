...
mkdir ${dir}/modelingResult_${covariates}/temp_${snp}_${g}
cd ${dir}/modelingResult_${covariates}/temp_${snp}_${g}
...
this_dir=${dir}/modelingResult_${covariates}/temp_${snp}_${g}
PBS_CPM=${this_dir}/PBS_${g}.txt
IFN_CPM=${this_dir}/IFN_${g}.txt
genotype=${this_dir}/genotype.txt
Rscript /pi/manuel.garber-umw/human/skin/eQTLs/DREG/scripts/build_linear_model_with_rankNorm_03252024.R ${dir} ${snp} ${g} ${covariates} ${PBS_CPM} ${IFN_CPM} ${genotype}
cd ${dir}/modelingResult_${covariates}
...
rm ${snp}*.txt
rm -r ${dir}/modelingResult_${covariates}/temp_${snp}_${g}
cd ${dir}
