...
#BSUB -W 24:00
#BSUB -q long
#BSUB -J QTL.KRT.mapping[1-53]%53
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/transqtl_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/transqtl_%J_%I.err"
