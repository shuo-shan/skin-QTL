...
#BSUB -W 72:00
#BSUB -q long
#BSUB -J QTL.KRT[147-186]%100 # run 100 jobs concurrently
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/qtl_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/qtl_%J_%I.err"
...
singularity exec /share/pkg/containers/rstudio_example/r_4.2.2.sif \
	Rscript ${DIR}/step1_run_QTL_chunk.R KRT 10 2 ${chunk_id}
