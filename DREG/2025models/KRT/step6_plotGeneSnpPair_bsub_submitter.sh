...
f=KRT_TNF_reQTL_gene_fdr05_table.txt
...
awk '{print "bash /pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/step6_plotGeneSnpPair.sh",$0}' ${DIR}/plots/pairs_for_${f} > ${DIR}/plots/commands_for_${f}
