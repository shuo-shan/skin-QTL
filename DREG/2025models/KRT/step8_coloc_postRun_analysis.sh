...
#BSUB -q long
#BSUB -W 08:00
#BSUB -J plot_coloc_gene_KRT
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/plot_coloc_genes_%J.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/plot_coloc_genes_%J.err"
