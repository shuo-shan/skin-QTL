...
#BSUB -W 2:00
#BSUB -q short
#BSUB -J QC.KRT[1-186]%50
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/conditionalAnalysisRound1_qc_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/conditionalAnalysisRound1_qc_%J_%I.err"
