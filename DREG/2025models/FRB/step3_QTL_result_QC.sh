...
#BSUB -W 2:00
#BSUB -q short
#BSUB -J QTL.FRB[1-273]%273
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/FRB/logs/qc_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/FRB/logs/qc_%J_%I.err"
