...
if (length(args) < 4) {
  cat("
Usage:
  Rscript step13_conditional_analysis_round1_postRun_eigenMT_by_gene_chunk.R <ct> <condition> <QTLtype> <chunk_id>

Example:
  Rscript step13_conditional_analysis_round1_postRun_eigenMT_by_gene_chunk.R KRT IFNG reQTL 076
", "\n")
