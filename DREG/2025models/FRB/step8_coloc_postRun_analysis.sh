...
#BSUB -q long
#BSUB -W 08:00
#BSUB -J plot_coloc_gene_FRB
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/FRB/logs/plot_coloc_genes_%J.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/FRB/logs/plot_coloc_genes_%J.err"
...
#
## [2] Coloc manhattan plots
#cp ${DIR}/coloc/${trait}/plots/FRB_${g}.locus_tracks.pdf ./
#cp ${DIR}/coloc/${trait}/plots_table/FRB_${g}.table.pdf ./
#
## [3] SNP annotations
#bigtable=/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/annotate_QTL/QTL_1E-02/compiled_table_${ct}.txt
#head -1 ${bigtable} | tr '\t' '\n' | awk '{print NR,$0}' > rownames.txt
