...
#BSUB -W 2:00
#BSUB -q short
#BSUB -J QC.FRB[1-273]%50
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/FRB/logs/conditionalAnalysisRound1_qc_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/FRB/logs/conditionalAnalysisRound1_qc_%J_%I.err"
...
for cond in PBS IFNG IFNB TNF; do
  Rscript ${DIR}/step13_conditional_analysis_round1_postRun_QC.R ${ct} \$cond eQTL  ${chunk_id}
done

for cond in IFNG IFNB TNF; do
  Rscript ${DIR}/step13_conditional_analysis_round1_postRun_QC.R ${ct} \$cond reQTL ${chunk_id}
done
"
