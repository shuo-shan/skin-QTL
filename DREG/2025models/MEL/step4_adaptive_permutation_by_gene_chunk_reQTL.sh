...
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/MEL/logs/round1_adaptive_permut_reQTL_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/MEL/logs/round1_adaptive_permut_reQTL_%J_%I.err"
...
singularity exec /share/pkg/containers/rstudio_example/r_4.2.2.sif \
	Rscript ${DIR}/step4_adaptive_perm_gene_reQTL_perGeneChunk.R MEL IFNG reQTL ${chunk_id}
singularity exec /share/pkg/containers/rstudio_example/r_4.2.2.sif \
	Rscript ${DIR}/step4_adaptive_perm_gene_reQTL_perGeneChunk.R MEL IFNB reQTL ${chunk_id}
singularity exec /share/pkg/containers/rstudio_example/r_4.2.2.sif \
	Rscript ${DIR}/step4_adaptive_perm_gene_reQTL_perGeneChunk.R MEL TNF reQTL ${chunk_id}
