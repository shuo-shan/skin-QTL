...
#BSUB -W 1:00
#BSUB -w "done(transQTL.KRT)"
#BSUB -q short
#BSUB -J makeManifest
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/transqtl_makeManifest_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/transqtl_makeManifest_%J_%I.err"
