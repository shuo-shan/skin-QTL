...
if (length(args) < 1) {
  cat("
Usage:
  Rscript step13_conditional_analysis_round1_postRun_BHcorrection.R  <infile>

Example:
  Rscript step13_conditional_analysis_round1_postRun_BHcorrection.R FRB_PBS_eQTL.eigenMT.txt", "\n")
...
dir <- paste0("/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/",ct,"/conditional_analysis_round1/eigenMT/results")
