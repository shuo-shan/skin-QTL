...
#BSUB -q long
#BSUB -J transQTL.KRT
#BSUB -o "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/transqtl_preprocessing_%J_%I.out"
#BSUB -e "/pi/manuel.garber-umw/human/skin/eQTLs/DREG/2025models/KRT/logs/transqtl_preprocessing_%J_%I.err"
