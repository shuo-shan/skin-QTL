...
dir <- "/pi/manuel.garber-umw/human/skin/eQTLs/website/data/modeling_results"
outDir <- paste0(dir,"/LDproxy")

inDir <- "/pi/manuel.garber-umw/human/skin/eQTLs/chromatin/annotate_QTL/QTL_1E-02/"
celltype <- "KRT"
