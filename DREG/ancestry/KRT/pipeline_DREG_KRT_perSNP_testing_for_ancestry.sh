...
while read g;do
	...
	Rscript /pi/manuel.garber-umw/human/skin/eQTLs/DREG/scripts/build_linear_model_with_ancestry_as_predictor.R ${dir} ${snp} ${g} ${covariates} ${PBS_CPM} ${IFN_CPM} ${genotype}
